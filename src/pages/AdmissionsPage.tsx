                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <div className="sm:col-span-2">
                      <button type="submit" className="w-full min-h-12 rounded-full bg-accent text-navy font-extrabold text-sm shadow-glow hover:bg-accent-light active:scale-[0.98] transition-all flex items-center justify-center gap-2">
